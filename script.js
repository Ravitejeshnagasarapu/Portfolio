...
const projects = [
  ...
  },
  {
    ...
    image: "contents/Images/Farmer_market_image.webp",
  },
  {
    ...
    image: "contents/Images/preview.webp",
  },
];
...
const initParallaxBlobs = () => {
  ...
  hero.addEventListener("mousemove", (e) => {
    // Reads cached 'rect' instead of forcing a browser reflow
...
document.addEventListener("DOMContentLoaded", () => {
  // 1. Critical: Render the Hero & Nav immediately
  initLoader();
  initTheme();
  initNavigation();
  initHeroButtons();
  
  // 2. Non-Critical: Delay everything else to unblock Main Thread
  setTimeout(() => {
    initParallaxBlobs(); // Heavy animation
    renderSkills();      // Heavy DOM creation
    renderExperience();
    initScrollAnimations();
    initProjects();      // Heavy DOM creation
    setCurrentYear();
    initScrollProgress();
